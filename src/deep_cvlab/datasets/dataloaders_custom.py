...
def main():
    ...
    dl = th.utils.data.DataLoader(ds, batch_size=batch_size, shuffle=shuffle, num_workers=num_workers, drop_last=drop_last) 
    ...
    dl = [th.utils.data.DataLoader(dataset, batch_size=batch, num_workers=0, shuffle=True, drop_last=True) 
